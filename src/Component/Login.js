...
export default function Login() {
  ...
  return (
    <div className="flex items-center justify-center bg-gradient-to-r to-blue-500 from-red-400 text-black">
        <form className=" p-6 rounded shadow-lg w-80 mt-28">
            ...
            <div className="mb-4">
                ...
                <input type="message"id="message"value={message}onChange={(e) => setmessage(e.target.value)}className="mt-1 block w-full p-2 border border-gray-300 rounded"required/>
            </div>
