...
export default function Contact() {
  return (
  <div id='Contact' className="bg-gradient-to-r to-blue-500 from-red-400  text-white flex justify-center">
     <div className=" p-6 rounded-lg shadow-lg mt-24">
      ...
      <p className="text-white mb-2 ml-14">Address: Ayyampalayam Kavindapadi 638455 Erode</p>
